	...
	private void addMouseHandler(final JLabel website) {
		website.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				try {
					Desktop.getDesktop().browse(new URI(parseHREF(website.getText())));
				} catch (Exception ex) {
				}
			}
		});
