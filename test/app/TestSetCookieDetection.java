...
public class TestSetCookieDetection {
	...
	public void testCookie() {
		...
		headers.add("Set-Cookie: token=eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJzdWIiOiIxMjM0NTY3ODkwIiwibmFtZSI6IkpvaG4gRG9lIiwiYWRtaW4iOnRydWV9.TJVA95OrM7E2cBab30RMHrHDcEfxjoYZgeFONFh7HgQ"); 
	...
	public void testCookieInvalidJWT() {
		...
		headers.add("Accept: text/html,application/xhtml+xml,application/xml;q=0.9,*/*;q=0.8"); 
		headers.add("Accept-Language: en-US,en;q=0.5"); 
		headers.add("Set-Cookie: token=INVALIDciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJzdWIiOiIxMjM0NTY3ODkwIiwibmFtZSI6IkpvaG4gRG9lIiwiYWRtaW4iOnRydWV9.TJVA95OrM7E2cBab30RMHrHDcEfxjoYZgeFONFh7HgQ");
		headers.add("Connection: close");
		headers.add("Upgrade-Insecure-Requests: 1");
		String result = cookie.findJWTInHeaders(headers);
